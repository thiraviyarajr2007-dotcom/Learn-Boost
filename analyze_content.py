...
for i, pdf_path in enumerate(pdf_paths, 1):
    print(f"Analyzing content from Term {i} PDF...")
...
output_file = r"c:\Users\thira\OneDrive - Rathinam Group Of Institutions\Desktop\My carrier\projects\learn-edu\content_analysis.json"
with open(output_file, 'w', encoding='utf-8') as f:
    json.dump(all_analysis, f, ensure_ascii=False, indent=2)

print(f"\nContent analysis saved to {output_file}")
